...
public class ClassDemo {
	...
	public void testCase5() throws InterruptedException {
		Thread.sleep(3000);
		//driver.findElement(By.xpath("//select[@aria-label='Day']")).sendKeys("16");
		WebElement findElement = driver.findElement(By.xpath("//select[@aria-label='Day']"));
		findElement.sendKeys("16",Keys.ENTER);
	}
	@AfterMethod
